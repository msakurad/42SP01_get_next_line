...
void	test_get_next_line_bonus_6_reading_2files(void)
{
	int		fd1;
	int		fd2;
	char	*str1;
...
{
	UNITY_BEGIN();
	RUN_TEST(test_get_next_line_bonus_1_reading_file);
	RUN_TEST(test_get_next_line_bonus_2_reading_file);
	RUN_TEST(test_get_next_line_bonus_3_reading_one_newline);
	RUN_TEST(test_get_next_line_bonus_4_try_to_read_closedfd);
	RUN_TEST(test_get_next_line_bonus_5_read_empty_file);
	RUN_TEST(test_get_next_line_bonus_6_reading_2files);
	UNITY_END();
}
